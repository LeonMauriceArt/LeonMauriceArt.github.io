...
export default {
  ...
  methods: {
    ...
    setupPostProcessing() {
      ...
      pixelationPass.uniforms['resolution'].value = new THREE.Vector2(300, 300);
      pixelationPass.uniforms['pixelSize'].value = 4.0; // Adjust this value for pixel size
    ...
    animate() {
      ...
      this.animateLoop = () => {
        ...
        if (this.model) {
          ...
          this.model.rotation.x =  Math.sin(this.floatFactor) * 0.6;
